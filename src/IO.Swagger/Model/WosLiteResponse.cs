...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class WosLiteResponse :  IEquatable<WosLiteResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WosLiteResponse" /> class.
        /// </summary>
        /// <param name="queryResult">queryResult.</param>
        /// <param name="data">The array of the Web of Science records.</param>
        public WosLiteResponse(QueryResult queryResult = default(QueryResult), List<WosLiteRecord> data = default(List<WosLiteRecord>))
        {
        ...
        /// </summary>
        /// <value>The array of the Web of Science records</value>
        [DataMember(Name="Data", EmitDefaultValue=false)]
        public List<WosLiteRecord> Data { get; set; }
        ...
        {
            return this.Equals(input as WosLiteResponse);
        }

        /// <summary>
        /// Returns true if WosLiteResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of WosLiteResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WosLiteResponse input)
        {
            if (input == null)
                return false;
