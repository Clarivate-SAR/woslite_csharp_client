...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class WosLiteRecordTitle :  IEquatable<WosLiteRecordTitle>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WosLiteRecordTitle" /> class.
        /// </summary>
        /// <param name="title">title.</param>
        public WosLiteRecordTitle(List<string> title = default(List<string>))
        {
            this.Title = title;
        }
        ...
        {
            return this.Equals(input as WosLiteRecordTitle);
        }

        /// <summary>
        /// Returns true if WosLiteRecordTitle instances are equal
        /// </summary>
        /// <param name="input">Instance of WosLiteRecordTitle to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WosLiteRecordTitle input)
        {
            if (input == null)
                return false;
